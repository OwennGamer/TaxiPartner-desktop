...
try {
    $stmt = $pdo->prepare("INSERT INTO pracownicy (
        id, name, firma, rodzaj_umowy, data_umowy, dowod, prawo_jazdy,
        niekaralnosc, orzeczenie_psychologiczne, data_badania_psychologicznego,
        orzeczenie_lekarskie, data_badan_lekarskich, informacja_ppk, rezygnacja_ppk,
        forma_wyplaty, wynagrodzenie_do_rak_wlasnych, zgoda_na_przelew,
        ryzyko_zawodowe, oswiadczenie_zus, bhp, regulamin_pracy,
        zasady_ewidencji_kasa, pit2, oswiadczenie_art188_kp, rodo, pora_nocna,
        pit_email, osoba_kontaktowa, numer_prywatny, numer_sluzbowy,
        model_telefonu_sluzbowego, operator, waznosc_wizy)
        VALUES (:id,:name,:firma,:rodzaj_umowy,:data_umowy,:dowod,:prawo_jazdy,
        :niekaralnosc,:orzeczenie_psychologiczne,:data_badania_psychologicznego,
        :orzeczenie_lekarskie,:data_badan_lekarskich,:informacja_ppk,:rezygnacja_ppk,
        :forma_wyplaty,:wynagrodzenie_do_rak_wlasnych,:zgoda_na_przelew,
        :ryzyko_zawodowe,:oswiadczenie_zus,:bhp,:regulamin_pracy,
